...
[**mark_word_learned**](UserApi.md#mark_word_learned) | **PUT** /user/{username}/{wordId} | Update word status for the user
...
# **mark_word_learned**
> mark_word_learned(username, word_id)
...
try:
    # Update word status for the user
    api_instance.mark_word_learned(username, word_id)
except ApiException as e:
    print("Exception when calling UserApi->mark_word_learned: %s\n" % e)
```

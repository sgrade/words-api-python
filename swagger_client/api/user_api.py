...
class UserApi(object):
    ...
    def mark_word_learned(self, username, word_id, **kwargs):  # noqa: E501
        """Update word status for the user  # noqa: E501

        This can only be done by the logged in user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.mark_word_learned(username, word_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.mark_word_learned_with_http_info(username, word_id, **kwargs)  # noqa: E501
        else:
            (data) = self.mark_word_learned_with_http_info(username, word_id, **kwargs)  # noqa: E501
            return data

    def mark_word_learned_with_http_info(self, username, word_id, **kwargs):  # noqa: E501
        """Update word status for the user  # noqa: E501

        This can only be done by the logged in user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.mark_word_learned_with_http_info(username, word_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['username', 'word_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method mark_word_learned" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'username' is set
        if ('username' not in params or
                params['username'] is None):
            raise ValueError("Missing the required parameter `username` when calling `mark_word_learned`")  # noqa: E501
        # verify the required parameter 'word_id' is set
        if ('word_id' not in params or
                params['word_id'] is None):
            raise ValueError("Missing the required parameter `word_id` when calling `mark_word_learned`")  # noqa: E501
